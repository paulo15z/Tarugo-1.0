...
DINABOX_SERVICE_USERNAME = os.getenv("DINABOX_SERVICE_USERNAME", "")
DINABOX_SERVICE_PASSWORD = os.getenv("DINABOX_SERVICE_PASSWORD", "")
DINABOX_TIMEOUT_SECONDS = int(os.getenv("DINABOX_TIMEOUT_SECONDS", "15"))
DINABOX_VERIFY_SSL = _env_bool("DINABOX_VERIFY_SSL", "1")
INTEGRACOES_SERVICE_USERNAME = os.getenv("INTEGRACOES_SERVICE_USERNAME", "integracoes-api")
